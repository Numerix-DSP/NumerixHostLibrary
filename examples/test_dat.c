...

{
    ...
    printf ("Opening and writing to test_file.dat file\n");

    if ((fpOutputFile = fopen ("test_file.dat", "wb")) == NULL) {   // Note this file is binary
    ...
    printf ("Opening and reading from test_file.dat file\n");

    if ((fpInputFile = fopen ("test_file.dat", "rb")) == NULL) {    // Note this file is binary
